...
public class FroggerScene extends Scene {
    ...
    public boolean isLevelCleared() {
        ...
        /**** implemented for 60/2 OOP ****/
        if(Difficult.getDiff()!=Difficult.Diffi.EASY)setLive(lives+1);
        /**** implemented for 60/2 OOP ****/
        if(Difficult.getDiff()!=Difficult.Diffi.NORMAL)addScore(500);
        /**** implemented for 60/2 OOP ****/
        if(Difficult.getDiff()!=Difficult.Diffi.HARD)addScore(1000);
        /**** implemented for 60/2 OOP ****/
